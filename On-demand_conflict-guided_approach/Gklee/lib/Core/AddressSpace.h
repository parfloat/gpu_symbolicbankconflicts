...
namespace klee {
  ...
  //adrianh
  typedef std::vector<MemoryAccessVec> LockStepAccessType;
  typedef std::map<AddressSpace*, LockStepAccessType> PerSharedMemType;
  typedef std::map<unsigned, PerSharedMemType> PerBarrIntervType;
  typedef std::map<unsigned, PerBarrIntervType> PerKernelType;
  typedef PerKernelType ShLineAccType;
  //adrianh end
  ...
  public:
    ...
    //adrianh data structure for storing per lockstep accesses
    ShLineAccType lineReadSharedLines;
    ShLineAccType lineWriteSharedLines;
    //adrianh end
    ...
    //adrianh
    void constructPerLineAccesses(Executor &, ExecutionState &, std::vector<CorrespondTid> &, unsigned, unsigned, unsigned);
    //adrianh end
